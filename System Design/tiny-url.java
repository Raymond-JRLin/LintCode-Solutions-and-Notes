...
public class TinyUrl {
    ...
    public String longToShort(String url) {
        ...
        while (true) {
            String shortURL = "http://tiny.url/" + getShortURL(url);
    ...
    private Map<String, String> map = new HashMap<>(); // <shortURL, longURL>
    private Random random = new Random();
    private String getShortURL(String s) {
        // choose random shortURL, careful about number (int) to char(a-zA-Z)
